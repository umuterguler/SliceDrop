...
namespace DefaultFolders
{
    public class FolderCreator : EditorWindow
    {
        ...
        void SetFolderNames()
        {
            ...
            CraeteFolder("Animation", new string[] { "Animations", "Animator", "Script" });
            CraeteFolder("Fonts", new string[] { "SDF", "Temp" });
            CraeteFolder("Images", new string[] { "Backgrounds", "UI" });            
            CraeteFolder("Materials", new string[] { "Temp" });
            CraeteFolder("Prefabs", new string[] { "Levels", "Models", "Object", "UI" }); 
            CraeteFolder("Scripts", new string[] { "Constant", "Controllers", "Data", "General", "UI" });
            CraeteFolder("Sounds", new string[] { "Music", "Sounds" });
            CraeteFolder("Textures", new string[] { "Temp" });
            CraeteFolder("XAssets", new string[] { "Zero" });
        }
